...
[![Screenshot](/public/social-image.png?raw=true)](https://mylenaverspeelt.com)

[![Website mylenaverspeelt.com](https://img.shields.io/website-up-down-green-00bfbf/http/shields.io.svg)](https://mylenaverspeelt.com)
...
A clean, responsive, single-page webapp template for developers. View demo at [mylenaverspeelt.com](https://mylenaverspeelt.com)

-   built using [React](https://reactjs.org/)
-   bootstrapped with [Create React App](https://github.com/facebook/create-react-app)
-   styled with [Material-UI](https://material-ui.com/)
-   deployed with [Vercel](https://vercel.com) and hosted at [mylenaverspeelt.com](https://mylenaverspeelt.com)
